            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="w-full lg:w-1/2 space-y-8">
                        ...
                        >
                            <button className="px-8 py-3.5 rounded-full bg-[#0066FF] text-white font-semibold shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all duration-300 flex items-center gap-2">
                                Explore Now
                            </button>
                            <button className="px-8 py-3.5 rounded-full bg-white text-gray-900 font-semibold border border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition-all duration-300">
                                Contact Us
                            </button>
                        </motion.div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 relative h-[600px] flex items-center justify-center">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                             <svg width="600" height="600" viewBox="0 0 600 600" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-30 text-blue-400">
