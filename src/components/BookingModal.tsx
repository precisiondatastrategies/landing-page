                                ...
                                <div className="lg:w-2/5 flex flex-col justify-center space-y-3 w-full">
                                    ...
                                    <div className="space-y-4 sm:space-y-6 pt-4">
                                        <div className="flex gap-3 sm:gap-4">
                                            ...
                                            <div>
                                                <p className="text-sm sm:text-base text-white leading-[150%]">Start with an AI Readiness Assessment  -  a deep operational audit with a prioritized EBITDA impact roadmap, formatted for your investment committee.</p>
                                            </div>
                                        </div>
                                        <div className="flex gap-3 sm:gap-4">
                                            <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-white/10 flex items-center justify-center">
