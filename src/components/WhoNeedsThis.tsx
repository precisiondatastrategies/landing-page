...
const PinnedScrollSections = () => {
    ...
    const sections = [
        ...
        },
        {
            ...
            description: 'You have a Technology Operating Partner and a value creation mandate. We integrate with your existing team as the AI implementation partner your strategy requires.',
        ...
        },
        {
            ...
            description: 'You were hired to deploy AI across the portfolio. The Big 4 quoted you $300K–$500K per company. We deliver working AI systems at a fraction of that cost and stay accountable to EBITDA impact.',
            features: ['AI readiness audit', 'Implementation sprint', 'One partner, entire portfolio'],
