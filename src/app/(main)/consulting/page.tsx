...
export default function ConsultingPage() {
    ...
    const ldJson = {
        ...
        "description": "Expert AI consulting services to help your business succeed through strategic planning, operational excellence, and digital transformation.",
        "url": "https://precisiondatastrategies.com/consulting",
        "areaServed": "US"
    };
                ...
                <section className="py-16 bg-blue-50/50 border-y border-blue-100">
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto text-center space-y-6">
                            ...
                            >
                                We partner with private equity firms and mid-sized companies to drive measurable efficiency across portfolios. From deep-dive AI readiness audits to rigorous execution, we implement AI and automation workflows that maximize EBITDA safely and confidentially.
                            </motion.p>
                            ...
                            <div className="w-full lg:w-1/2 relative h-[600px]">
                                ...
                                >
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        "Precision Data Strategies helped us unlock 30% more efficiency with disciplined execution."
                                    </p>
                                </motion.div>
                            </div>
                        </div>
