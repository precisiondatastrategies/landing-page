...
export default async function BlogPage() {
  ...
  const ldJson = {
    ...
    "@type": "CollectionPage",
    "name": "Precision Data Blog",
    "description": "Latest updates and insights on AI automation, data precision, and business efficiency from Precision Data.",
    "url": "https://precisiondatastrategies.com/blog",
    "publisher": {
      "@type": "Organization",
      "name": "Precision Data Strategies",
      "logo": {
        "@type": "ImageObject",
        "url": "https://precisiondatastrategies.com/logo.png"
      }
    }
  };
