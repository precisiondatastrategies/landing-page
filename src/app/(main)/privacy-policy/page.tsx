        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <div id="information-sharing" className="scroll-mt-32 mb-16">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>SMS/Mobile Opt-In Information:</strong> All categories of information sharing described in this section exclude text messaging originator opt-in data and consent — this information will not be sold or shared with any third party for promotional or marketing purposes, under any circumstance, including with our affiliates or business partners. We will not share your SMS opt-in status with any third party for purposes unrelated to providing you with the services of that campaign. We may share your SMS opt-in or consent status only with vendors who help us deliver the messaging service itself, such as our messaging platform provider and telecommunications carriers.</li>
